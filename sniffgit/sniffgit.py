...
IGNORED_FILE = set(["site-packages", "bin", "node_modules", "bower_components", "tmp", "__pycache__", "db", ".git"])
...
'''
def get_sensitive_lines(file_name, path_to_file, gitignored_files):
    sen_lines = []
...
def main():
    ...
    while len(q) > 0:
        ...
        for file_name in file_list:
            ...
            sen_lines = get_sensitive_lines(file_name, path_to_file, gitignored_files)
    ...
    print_result(safe_sensitive_files, exposed_sensitive_files, sensitive_lines)
